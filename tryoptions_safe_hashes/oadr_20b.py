...
from tryoptions_safe_hashes.oadr_atom import Feed
...
from tryoptions_safe_hashes.oadr_emix_20b import ItemBaseType
from tryoptions_safe_hashes.oadr_iso_iso3_alpha_currency_code_20100407 import Iso3AlphaCurrencyCodeContentType
from tryoptions_safe_hashes.oadr_power_20b import (
    EnergyApparent,
    EnergyItem,
    EnergyReactive,
    EnergyReal,
...
from tryoptions_safe_hashes.oadr_pyld_20b import (
    EiCreatedEvent,
    EiRequestEvent,
)
from tryoptions_safe_hashes.oadr_siscale_20b import SiScaleCodeType
from tryoptions_safe_hashes.oadr_strm_20b import (
    StreamBaseType,
    StreamPayloadBaseType,
)
from tryoptions_safe_hashes.oadr_xcal_20b import DurationPropType
from tryoptions_safe_hashes.oadr_xmldsig import Signature
...
class OadrPendingReportsType:
    ...
    report_request_id: Tuple[str, ...] = field(
...
class OadrDistributeEventType:
    ...
    oadr_event: Tuple["OadrDistributeEventType.OadrEvent", ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrEvent",
            "type": "Element",
...
class OadrServiceSpecificInfo:
    ...
    oadr_service: Tuple["OadrServiceSpecificInfo.OadrService", ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrService",
            "type": "Element",
    ...
    class OadrService:
        ...
        oadr_info: Tuple[OadrInfo, ...] = field(
            default_factory=tuple,
            metadata={
                "name": "oadrInfo",
                "type": "Element",
...
class OadrTransports:
    ...
    oadr_transport: Tuple["OadrTransports.OadrTransport", ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrTransport",
            "type": "Element",
...
class OadrProfiles:
    ...
    oadr_profile: Tuple["OadrProfiles.OadrProfile", ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrProfile",
            "type": "Element",
...
class OadrCreateReportType:
    ...
    oadr_report_request: Tuple[OadrReportRequest, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrReportRequest",
            "type": "Element",
...
class OadrCreatedPartyRegistrationType:
    ...
    class OadrExtensions:
        oadr_extension: Tuple["OadrCreatedPartyRegistrationType.OadrExtensions.OadrExtension", ...] = field(
            default_factory=tuple,
            metadata={
                "name": "oadrExtension",
                "type": "Element",
...
class OadrReportType(StreamBaseType):
    ...
    oadr_report_description: Tuple[OadrReportDescription, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrReportDescription",
            "type": "Element",
...
class OadrRegisterReportType:
    ...
    oadr_report: Tuple[OadrReport, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrReport",
            "type": "Element",
