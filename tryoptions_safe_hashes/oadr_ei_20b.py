...
from tryoptions_safe_hashes.oadr_20b import (
    Therm,
    Currency,
    CurrencyPerKw,
    CurrencyPerKwh,
...
from tryoptions_safe_hashes.oadr_emix_20b import ServiceArea
...
from tryoptions_safe_hashes.oadr_xcal_20b import (
    DurationPropType,
...
class ArrayofResponses:
    ...
    """
    response: Tuple[EiResponseType, ...] = field(
...
@dataclass(frozen=True)
class EiTargetType:
    aggregated_pnode: Tuple[AggregatedPnode, ...] = field(
        default_factory=tuple,
        metadata={
    ...
    end_device_asset: Tuple[EndDeviceAsset, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "endDeviceAsset",
            "type": "Element",
    ...
    meter_asset: Tuple[MeterAsset, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "meterAsset",
            "type": "Element",
    ...
    service_area: Tuple[ServiceArea, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "serviceArea",
            "type": "Element",
    ...
    service_delivery_point: Tuple[ServiceDeliveryPoint, ...] = field(
        default_factory=tuple,
        metadata={
    ...
    service_location: Tuple[ServiceLocation, ...] = field(
        default_factory=tuple,
        metadata={
    ...
    transport_interface: Tuple[TransportInterface, ...] = field(
        default_factory=tuple,
        metadata={
...
class EventResponses:
    ...
    event_response: Tuple["EventResponses.EventResponse", ...] = field(
        default_factory=tuple,
        metadata={
            "name": "eventResponse",
            "type": "Element",
...
class ReportSpecifierType:
    ...
    specifier_payload: Tuple[SpecifierPayload, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "specifierPayload",
            "type": "Element",
...
class IntervalType:
    ...
    oadr_report_payload: Tuple[OadrReportPayload, ...] = field(
        default_factory=tuple,
        metadata={
    ...
    oadr_gbpayload: Tuple[OadrGbpayload, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "oadrGBPayload",
            "type": "Element",
    ...
    signal_payload: Tuple[SignalPayload, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "signalPayload",
            "type": "Element",
...
class EiEventSignalsType:
    ...
    ei_event_signal: Tuple[EiEventSignal, ...] = field(
        default_factory=tuple,
        metadata={
            "name": "eiEventSignal",
            "type": "Element",
